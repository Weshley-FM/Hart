...
if (isset($_POST['update'])) {
    ...
    $query = "UPDATE subcription SET  username='$username', password='$password', email='$email', role='$role', subcription='$subcription'  WHERE id_user=$id_user";
...
if (isset($_GET['id'])) {
    $id_user = $_GET['id'];
    $query = "SELECT * FROM subcription WHERE id_user=$id_user";
    $result = mysqli_query($mysqli, $query);
    ...
    <div class="container">
        ...
        <section class="form">
            <form method="POST" action="">
                ...
                <input type="text" id="role" name="role" value="<?php echo $data['role']; ?>"><br>

                <label for="name">subcription:</label><br>
                <input type="text" id="subcription" name="subcription" value="<?php echo $data['subcription']; ?>"><br>
